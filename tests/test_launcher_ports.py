...
# The bare-name `call` trap that half-completed this promotion lives in its own
# whole-repo guard, tools/tests/test_batch_call_paths.py — it covers every .bat
# in the repo, not just the launchers named here, and excludes `call :label`.
