...
def test_nav_section_captions_and_their_derived_counts():
    ...
    The leading ``None`` caption is the pinned landing block (Desk + its Live
    Mirror), which renders no header at all — see
    ``test_the_landing_block_is_pinned_above_every_caption``.
    """
    import inspect
    import main
