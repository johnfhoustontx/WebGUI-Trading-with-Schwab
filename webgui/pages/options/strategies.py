...
_STRATEGY_FACTS = {
    ...
    "NAKED_PUT":  ("CREDIT", ["ASSIGNMENT", "BULLISH"],
    ...
    "CONDOR_CALL": ("DEBIT", ["RANGE", "THETA"],
                    "All-call condor: long the outer strikes, short the two in the middle. Pays most if spot finishes between the short strikes — which sit above spot, so it leans bullish."),
    "CONDOR_PUT": ("DEBIT", ["RANGE", "THETA"],
                   "All-put condor: long the outer strikes, short the two in the middle. Pays most if spot finishes between the short strikes — which sit below spot, so it leans bearish."),
