...
# The dealer-structure vocabulary moved to pages/structure.py when the Symbol
# Dossier became its second reader. Imported back BY NAME, under the names this
# module (and test_desk) always used, so nothing here changes.
from pages.structure import (CALL_HEX, FLIP_HEX, PUT_HEX,  # noqa: F401
                             REGIME_WORDS, SPOT_HEX, regime_word)
from pages.structure import NO_REGIME as _NO_REGIME
from pages.structure import flip_read as _flip_read
from pages.structure import structure_map as _structure_map
from pages.structure import walls_trustworthy as _walls_trustworthy
