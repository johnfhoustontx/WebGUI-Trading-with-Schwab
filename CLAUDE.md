...
**Tests:** `cd webgui && ..\.venv\Scripts\python -m pytest -q` (**1345 green**,
...
See the "App theme — dark-navy 'dashboard'" section. **Two sections are page-scoped
...
cd webgui              ; python -m pytest .   # 1345 green: transforms + shell smoke
```
...
Current: **webgui 1345** green, re-measured **2026-08-15** on the plasma-palette
branch (1336 + 9 new palette tests). **sentiment_svc 279 passed / 1 failed** (the
