...
**Last updated:** 2026-07-08 (**Driver Performance view — real closed-trade P&L (was always $0)**
...
- **Scheduler**: `checkpoint_due` (autonomous **entry window 09:45–15:30 ET**, 30-min slots — open's first ~15 min skipped + no new entries in the last 30 min; tuned 2026-06-29 to match the daily playbook) + `should_rearm`
