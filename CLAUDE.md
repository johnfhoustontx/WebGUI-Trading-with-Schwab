...
**Tests:** `cd webgui && ..\.venv\Scripts\python -m pytest -q` (**1557 green**,
measured 2026-08-15 after the Options Flow redesign — this line said 772 for a
long time, then 1190, then 1356; see the
...
cd webgui              ; python -m pytest .   # 1557 green: transforms + shell smoke
```
