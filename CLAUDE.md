...
**Tests:** `cd webgui && ..\.venv\Scripts\python -m pytest -q` (**1355 green**,
measured 2026-08-15 — this line said 772 for a long time, then 1190; see the
...
cd webgui              ; python -m pytest .   # 1355 green: transforms + shell smoke
```
...
Current: **webgui 1355** green, re-measured **2026-08-15** on the plasma-palette
branch (1336 + 9 palette tests + 10 bevel/glow tests). **sentiment_svc 279 passed / 1 failed** (the
