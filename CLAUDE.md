...
| `/sentiment/rrg` | RRG — **hand-drawn** relative-rotation plot (markers over an SVG trail layer, quadrant washes, fixed crosshair); **marker AREA = S&P weight**, trail = the **last 5 readings**. Domain is computed + symmetric about 100. Cached, manual Refresh only. [Detail](docs/webgui-routes.md) | built |
