...
# Meteor-tail: how many trailing daily RRG points to PLOT per sector and the day
# stride between them (every other day → spans ~24 trading days with 12 points;
# oldest -> newest, last == current reading).
TAIL_LENGTH = 12
TAIL_STRIDE = 2
